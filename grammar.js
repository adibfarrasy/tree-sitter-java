...
module.exports = grammar({
  ...
  extras: ($) => [$.line_comment, $.block_comment, $.javadoc_comment, /\s/],
  ...
  rules: {
    ...
    _toplevel_statement: ($) => choice($.statement, $.function_declaration),
    ...
    hex_floating_point_literal: (_) =>
      token(
        seq(
          ...
          optional(
            seq(/[pP]/, optional(choice("-", "+")), DIGITS, optional(/[fFdD]/)),
          ),
        ),
      ),
    ...
    catch_clause: ($) =>
      seq("catch", "(", $.catch_parameter, ")", field("body", $.block)),
    ...
    enum_declaration: ($) =>
      seq(
        optional(field("documentation", $.javadoc_comment)),
        optional($.modifiers),
        "enum",
